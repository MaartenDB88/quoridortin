...
public class PersistentieBeheerder {
    ...
    //GETLIJSTMUREN()
    public List<vak> getLijstMuren() {

        return spelMapper.getMuren();
    }//end method getLijstMuren

    //SPEL OPSLAAN()
    public void spelOpslaan(String naam,Spel spel) {

        spelMapper.spelOpslaan(naam, spel.getDimensie(), spel.getSpelers(), spel.getMuurVakken(),spel.getWallLength());
