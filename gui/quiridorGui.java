 ...
 * quiridorGui.java
 *
 * Created on 15-apr-2010, 21:14:44
 */
 ...
 * @author Admin
 */
public class quiridorGui extends javax.swing.JFrame {

    /** Creates new form quiridorGui */
    public quiridorGui() {
        initComponents();
        this.addMouseMotionListener(bordPaneel1);
        this.addMouseListener(bordPaneel1);
    }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new quiridorGui().setVisible(true);
